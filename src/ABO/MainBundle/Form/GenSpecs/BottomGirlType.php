...
class BottomGirlType extends AbstractType {
            ...
            ->add('age', EntityType::class, array(
                ...
                'query_builder' => function(EntityRepository $er) {
                    return $er->createQueryBuilder('s')
                        ...
                        ->setParameters(array('type'=>'age','age'=>'tn','sexe'=>'mf','clothe'=>'st'));
                },
                'choice_label' => 'value',
            ...
            ->add('eur', EntityType::class, array(
                ...
                'query_builder' => function(EntityRepository $er) {
                    return $er->createQueryBuilder('s')
                        ...
                        ->andWhere('s.sexe = :sexe')
                        ->andWhere('s.clothe = :clothe')
                        ->setParameters(array('type'=>'eur','age'=>'tn','sexe'=>'fm','clothe'=>'st'));
                },
                'choice_label' => 'value',
